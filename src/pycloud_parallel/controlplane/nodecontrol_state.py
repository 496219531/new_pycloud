...
class NodeControlState(NodeRuntimeBase):
    ...
    def __init__(
        ...
        *,
        ...
        self.control_base_url = str(control_base_url or "").strip()
    ...
    def node_capability(self) -> NodeCapability:
        return detect_local_node_capability(
            supports_http_control=bool(str(self.control_base_url or "").strip()),
            control_base_url=str(self.control_base_url or "").strip(),
        )
    ...
    def _collect_registrar_task_stats_locked(self) -> Dict[str, object]:
    ...
    def _collect_registrar_timing_metadata_locked(self) -> Dict[str, str]:
        ...
        if service_timing_payload:
            out["service_timing_metrics"] = json.dumps(
                service_timing_payload,
                ensure_ascii=False,
                separators=(",", ":"),
            )
        if pool_timing_payload:
            out["task_pool_timing_metrics"] = json.dumps(
                pool_timing_payload,
                ensure_ascii=False,
                separators=(",", ":"),
            )
