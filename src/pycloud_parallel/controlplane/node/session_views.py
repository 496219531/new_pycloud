...
def build_service_status_info(session: ServiceSession, *, in_flight: int) -> Dict[str, object]:
    ...
    return {
        ...
        "requested_workers": resource.requested_workers,
        "alive_workers": resource.alive_workers,
        "busy_workers": resource.busy_workers,
        "in_flight": resource.in_flight,
        "queued": resource.queued,
        "worker_pids": list(resource.worker_pids),
        "executor_generation": resource.executor_generation,
...
def build_service_report_payload(session: ServiceSession, *, in_flight: int) -> Dict[str, object]:
    ...
    return {
        ...
        "requested_workers": int(resource.requested_workers),
        "alive_workers": int(resource.alive_workers),
        "busy_workers": int(resource.busy_workers),
        "queued": int(resource.queued),
        "worker_pids": list(resource.worker_pids),
        "executor_generation": int(resource.executor_generation),
