        ...
        task_pools = [
            {
                ...
                "requested_workers": int(getattr(item, "requested_workers", item.worker_count) or 0),
                "alive_workers": int(getattr(item, "alive_workers", 0) or 0),
                "busy_workers": int(getattr(item, "busy_workers", 0) or 0),
                "queued": int(getattr(item, "queued", 0) or 0),
                "worker_pids": list(getattr(item, "worker_pids", ()) or ()),
                "executor_generation": int(getattr(item, "executor_generation", 0) or 0),
